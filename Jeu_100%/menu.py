...
class Menu_principal:
	...
	def __init__(self, screen, screen_size):
		...
		self.start_button = Button((self.screen_size[0] // 2) - self.start_btn_size[0] // 2, (self.screen_size[1] // 2.5) - self.start_btn_size[1] // 2, self.start_btn, 0.8)
			
		self.exit_btn = pygame.image.load("Assets/exit_btn.png")
		self.exit_btn_size = self.exit_btn.get_size()
		self.exit_button = Button((self.screen_size[0] // 2) - self.exit_btn_size[0] // 2, (self.screen_size[1] // 2) - self.exit_btn_size[1] // 2, self.exit_btn, 0.8)
...
class Selection_competence_droite:
	...
	def __init__(self, screen, screen_size):
		...
		self.competence_1_droite = Button((self.screen_size[0] // 2) + self.competence_1_size_droite[0], (self.screen_size[1] // 3.5) - self.competence_1_size_droite[1] // 2, self.compet_1_droite, 0.8)
		...
		self.competence_2_droite = Button((self.screen_size[0] // 2) + self.competence_2_size_droite[0], (self.screen_size[1] // 2.5) - self.competence_2_size_droite[1] // 2, self.compet_2_droite, 0.8)
		...
		self.competence_3_droite = Button((self.screen_size[0] // 2) + self.competence_3_size_droite[0], (self.screen_size[1] // 1.9) - self.competence_3_size_droite[1] // 2, self.compet_3_droite, 0.8)
		...
		self.competence_4_droite = Button((self.screen_size[0] // 2) + self.competence_4_size_droite[0], (self.screen_size[1] // 1.5) - self.competence_4_size_droite[1] // 1.5, self.compet_4_droite, 0.8)
		...
		self.competence_1_droite_selec = Button((self.screen_size[0] // 2) + self.competence_1_size_droite_selec[0], (self.screen_size[1] // 3.5) - self.competence_1_size_droite[1] // 2, self.compet_1_droite_selec, 0.8)
		...
		self.competence_2_droite_selec = Button((self.screen_size[0] // 2) + self.competence_2_size_droite_selec[0], (self.screen_size[1] // 2.5) - self.competence_2_size_droite[1] // 2, self.compet_2_droite_selec, 0.8)
		...
		self.competence_3_droite_selec = Button((self.screen_size[0] // 2) + self.competence_3_size_droite_selec[0], (self.screen_size[1] // 1.9) - self.competence_3_size_droite[1] // 2, self.compet_3_droite_selec, 0.8)
		...
		self.competence_4_droite_selec = Button((self.screen_size[0] // 2) + self.competence_4_size_droite_selec[0], (self.screen_size[1] // 1.5) - self.competence_4_size_droite[1] // 1.5, self.compet_4_droite_selec, 0.8)
...
class Selection_competence_gauche:
	...
	def __init__(self, screen, screen_size):
		...
		self.competence_1_gauche = Button(self.screen_size[0] // 4, (self.screen_size[1] // 3.5) - self.competence_1_size_gauche[1] // 2, self.compet_1_gauche, 0.8)
		...
		self.competence_2_gauche = Button(self.screen_size[0] // 4, (self.screen_size[1] // 2.5) - self.competence_2_size_gauche[1] // 2, self.compet_2_gauche, 0.8)
		...
		self.competence_3_gauche = Button(self.screen_size[0] // 4, (self.screen_size[1] // 1.9) - self.competence_3_size_gauche[1] // 2, self.compet_3_gauche, 0.8)
		...
		self.competence_4_gauche = Button(self.screen_size[0] // 4, (self.screen_size[1] // 1.5) - self.competence_4_size_gauche[1] // 1.5, self.compet_4_gauche, 0.8)
		...
		self.competence_1_gauche_selec = Button(self.screen_size[0] // 4, (self.screen_size[1] // 3.5) - self.competence_1_size_gauche[1] // 2, self.compet_1_gauche_selec, 0.8)
		...
		self.competence_2_gauche_selec = Button(self.screen_size[0] // 4, (self.screen_size[1] // 2.5) - self.competence_2_size_gauche[1] // 2, self.compet_2_gauche_selec, 0.8)
		...
		self.competence_3_gauche_selec = Button(self.screen_size[0] // 4, (self.screen_size[1] // 1.9) - self.competence_3_size_gauche[1] // 2, self.compet_3_gauche_selec, 0.8)
		...
		self.competence_4_gauche_selec = Button(self.screen_size[0] // 4, (self.screen_size[1] // 1.5) - self.competence_4_size_gauche[1] // 1.5, self.compet_4_gauche_selec, 0.8)
